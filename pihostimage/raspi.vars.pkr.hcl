variable "hostname" {
  description = "The hostname identifier of your doorstation."
  type        = string
  default     = "doorstation"
  sensitive   = false
}
...
#
variable "timezone" {
  description = "Timezone to run the doorstation in"
  type        = string
  default     = "UTC"
  sensitive   = false
}
...
variable "locale" {
  description = "Language/locale setting the doorstation uses"
  type        = string
  default     = "en_GB"
  sensitive   = false
}
...
#
variable "user" {
  description = "Non-root service account name the doorstation runs on"
  type        = string
  default     = "doorstation"
  sensitive   = false
}
...
variable "user_description" {
  ...
  type        = string
  default     = "Doorstation service user"
  sensitive   = false
}
